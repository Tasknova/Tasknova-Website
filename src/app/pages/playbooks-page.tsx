...
import { 
  BookOpen, Download, CheckCircle2, ArrowRight, FileText, Users, TrendingUp, Target
} from "lucide-react";
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-slate-200">
                      ...
                      <button className={`px-6 py-3 rounded-lg bg-gradient-to-r ${playbook.gradient} text-white font-semibold hover:opacity-90 transition-opacity group-hover:scale-105`}>
                        Download
